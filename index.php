...
if ($y == 'Admin') {
	echo header("Location:qr/add.php");
...
if(isset($_POST['signup']))
{
	...
	$sql="insert into LMS.users (Name,Type,Category,Department,RollNo,EmailId,MobNo,Password) values ('$name','$type','$category','$department','$rollno','$email','$mobno','$password')";
